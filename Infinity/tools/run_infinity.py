...
def add_common_arguments(parser):
    ...
    # === [Added for VAR-Scaling Arguments] ===
    parser.add_argument('--enable_scaling', type=int, default=0, choices=[0,1], help="Enable VAR-Scaling inference strategy")
    parser.add_argument('--scaling_layer_idx', type=int, default=3, help="Layer index to apply scaling search")
    parser.add_argument('--scaling_num_samples', type=int, default=3000, help="Number of samples to search for density estimation")
    ...
    with autocast(dtype=torch.bfloat16):
        with torch.no_grad():
            generated_image = gen_one_img(
                ...
                scaling_layer_idx=args.scaling_layer_idx,
                scaling_num_samples=args.scaling_num_samples,
            )
